...
TEST(TestStreamUtils, General)
{
  ...
  EXPECT_EQ(8, StreamUtils::GetCodecPriority("pcm"));
  EXPECT_EQ(9, StreamUtils::GetCodecPriority("dtshd_ma_x"));
  EXPECT_EQ(9, StreamUtils::GetCodecPriority("dts_x"));
  EXPECT_EQ(9, StreamUtils::GetCodecPriority("dtsx"));
  EXPECT_EQ(9, StreamUtils::GetCodecPriority("dts-x"));
  EXPECT_EQ(9, StreamUtils::GetCodecPriority("dts:x"));
