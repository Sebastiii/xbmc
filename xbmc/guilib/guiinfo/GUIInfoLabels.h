...
#define VIDEOPLAYER_SUBTITLE_CODEC    307
#define VIDEOPLAYER_HDR_DETAIL        308
...
#define PLAYER_PROCESS_AUDIO_OBJECT_COUNT (PLAYER_PROCESS + 14)
...
#define PLAYER_PROCESS_VIDEO_SIDEDATA (PLAYER_PROCESS + 34)
...
#define PLAYER_PROCESS_VIDEO_ACTIVE_AREA_TOP (PLAYER_PROCESS + 186)
#define PLAYER_PROCESS_VIDEO_ACTIVE_AREA_BOTTOM (PLAYER_PROCESS + 187)
#define PLAYER_PROCESS_VIDEO_ACTIVE_AREA_TOP_LINES (PLAYER_PROCESS + 196)
#define PLAYER_PROCESS_VIDEO_ACTIVE_AREA_BOTTOM_LINES (PLAYER_PROCESS + 197)
...
#define PLAYER_PROCESS_VIDEO_SOURCE_DOVI_META_VERSION (PLAYER_PROCESS + 105)
...
#define PLAYER_PROCESS_AML_DV_TYPE_RAW (PLAYER_PROCESS + 182)
...
#define PLAYER_PROCESS_RENDER_PTS (PLAYER_PROCESS + 145)

#define PLAYER_PROCESS_AML_VP_MODE (PLAYER_PROCESS + 147)
...
#define PLAYER_PROCESS_AUDIO_OBJECT_CHANNELS (PLAYER_PROCESS + 183)
#define PLAYER_PROCESS_AUDIO_OBJECT_DESCRIPTION (PLAYER_PROCESS + 184)
#define PLAYER_PROCESS_AUDIO_DIALNORM (PLAYER_PROCESS + 185)

#define PLAYER_PROCESS_AUDIO_LAYOUT_NAME (PLAYER_PROCESS + 190)
#define PLAYER_PROCESS_AUDIO_LAYOUT_NAME_SINK (PLAYER_PROCESS + 191)

#define PLAYER_PROCESS_VIDEO_HDR_MAX_CLL_LIMITED (PLAYER_PROCESS + 192)
#define PLAYER_PROCESS_VIDEO_HDR_MAX_LUM_LIMITED (PLAYER_PROCESS + 193)

#define PLAYER_PROCESS_AUDIO_SPK_BC (PLAYER_PROCESS + 194)
#define PLAYER_PROCESS_AUDIO_SPK_SINK_BC (PLAYER_PROCESS + 195)
#define PLAYER_PROCESS_AUDIO_BED_CHANNELS (PLAYER_PROCESS + 198)

#define ADDON_INFOS                 1700

static_assert(PLAYER_PROCESS_AUDIO_BED_CHANNELS < ADDON_INFOS,
              "PLAYER_PROCESS offsets overflow into ADDON_INFOS");
...
#define LISTITEM_AUDIO_PROFILE      (LISTITEM_START + 219)
#define LISTITEM_AUDIO_OBJECTS      (LISTITEM_START + 220)
#define LISTITEM_AUDIO_OBJECT_CHANNELS (LISTITEM_START + 221)
#define LISTITEM_AUDIO_BED_CHANNELS (LISTITEM_START + 222)
