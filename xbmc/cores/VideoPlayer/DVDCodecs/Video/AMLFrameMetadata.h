...
struct AMLFrameMetadata
{
  ...
  bool operator==(const AMLFrameMetadata& other) const
  {
    return doviConfig == other.doviConfig && flags == other.flags &&
           structure == other.structure && doviRpu == other.doviRpu &&
           hdr10pSei == other.hdr10pSei && hdrMdcv == other.hdrMdcv && hdrCll == other.hdrCll;
  }

  bool operator!=(const AMLFrameMetadata& other) const { return !(*this == other); }
...
private:
  ...
  static constexpr double PTS_TOLERANCE = 1000.0;
